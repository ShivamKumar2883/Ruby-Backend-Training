...
ActiveRecord::Schema[8.0].define(version: 2025_08_04_070746) do
  ...
  create_table "conference_categories", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["conferences_id"], name: "index_conference_categories_on_conferences_id"
  end
  ...
  create_table "conferences", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["badges_id"], name: "index_conferences_on_badges_id"
  ...
  create_table "point_of_contacts", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["conference_id"], name: "index_point_of_contacts_on_conference_id"
  ...
  add_foreign_key "conference_categories", "conferences", column: "conferences_id"
  add_foreign_key "conferences", "badges", column: "badges_id"
  ...
  add_foreign_key "point_of_contacts", "conferences"
